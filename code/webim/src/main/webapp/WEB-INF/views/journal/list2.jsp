   	...
   	<form action="<c:url value="/journal/createJournal" />" method="post">
        <div class="form-group">
            ...
            <select id="images" name="images" multiple class="form-control">
                <option value="P0440044.JPG">P0440044.JPG</option>
                <option value="P0440045.JPG">P0440045.JPG</option>
                <option value="P0440046.JPG">P0440046.JPG</option>
                <option value="P0440047.JPG">P0440047.JPG</option>
                <option value="P0440048.JPG">P0440048.JPG</option>
                <option value="P0440049.JPG">P0440049.JPG</option>
                <option value="P0440050.JPG">P0440050.JPG</option>
            </select>
        </div>
        <div class="form-group">
